...
struct RaycastResult {
    ...
    Vec3f orig, dir;        // The traced ray. Convenience for tracing and
                            // visualization. This is not strictly needed.

    Vec3f dPdx, dPdy, dDdx,
        dDdy;  // EXTRA: Partial derivatives for texture filtering.
    Vec2f delta_size;

    RaycastResult(const RTTriangle* tri, float t, float u, float v, Vec3f point,
