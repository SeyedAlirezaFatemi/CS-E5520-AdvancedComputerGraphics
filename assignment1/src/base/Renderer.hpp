...
class Renderer {
   public:
    ...
    timingResult rayTracePicture(RayTracer*, Image*,
   ...
   protected:
    ...
    Vec3f m_pointLightPos;  // Position for the simple pointlight you can use
                            // for the whitted integrator.
    std::vector<RTTriangle*>
        m_lightTriangles;  // Contains all triangles with an emission of over 0
                           // in the scene. Can be used for the area lights
                           // extra in order to sample random light-emitting
