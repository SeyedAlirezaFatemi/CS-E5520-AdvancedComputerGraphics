...
class AreaLight {
   public:
    ...
    // the "index" input can be used for driving QMC samplers; unless you do something to it
   ...
   protected:
    ...
    Vec2f m_size;   // Physical size of the emitter from the center of the light. I.e. half of the
                    // total width/height.
